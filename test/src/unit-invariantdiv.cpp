...
TEST_CASE("Test division invariant integer")
{
  ...
  SECTION("Division by invariant integer")
  {
    ...
    REQUIRE(quotient(to_big_int(983475380176018765409862740849389839818376450874681244_Z),
                     182016134597461982754761_Z) == to_big_int(5403231874751241207206728823349_Z));
  }

  SECTION("Division by power of two")
  {
    REQUIRE(quotient(to_big_int(983475380176018765409862740849389839818376450874681244_Z), 16_Z) ==
  ...
  SECTION("Modulo reduction")
  {
    ...
    static_assert(mod(to_big_int(31892671234697813764376159476_Z), 837201975682367548938754_Z) ==
                  to_big_int(299173053704355103264600_Z));

    static_assert(
      mod(to_big_int(31892687983792345871234697813764376159476_Z), 83720129120938471902840198708975682367548938754_Z) ==
      to_big_int(31892687983792345871234697813764376159476_Z));

    static_assert(mod(to_big_int(31892687983792345871234697813764376159476_Z),
                      83720129181230479813709817203921820938471902840198708975682367548938754_Z) ==
                  to_big_int(31892687983792345871234697813764376159476_Z));
    ...
    constexpr auto n2 =
      to_big_int(1918364187619837651267354918237508463169875469187436983576158736587620837561389746587368276987232_Z);
