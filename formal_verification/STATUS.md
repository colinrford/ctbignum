...
## Summary
The verification code in this repository has been fully modernized to support **C++20 Modules** and **C++23** standards. However, as of Jan 2026, the extending author has not been able to successfully run the external verification tools **SAW** and **ct-verif** with modularized `ctbignum`.
...
## How to Run (Future)
Once the tools are compatible with modularized `ctbignum`, the following steps can be used to run the verification:
